      ...
      <header className="site-header">
        <div className="header-inner">
          <a href="#" className="brand-logo">
            <img src="/humblbar_logo.png?v=6" alt="HumblBar Logo" className="brand-logo-img" />
          </a>
        </div>
      </header>
        ...
        <div className="footer-container">
          <div className="footer-inner" style={{ justifyContent: 'center', textAlign: 'center' }}>
            <div className="footer-logo-wrap">
              <img src="/humblbar_logo.png?v=6" alt="HumblBar Logo" className="brand-logo-img footer-logo-img" />
            </div>
          </div>
